            ...
            <div className="postDepartmentLocation-page-edit__form-fields form__fields">
                <div className="postDepartmentLocation-page-edit__form-field form__field">
                    <label>
                        ...
                        <Field className="postDepartmentLocation-page-edit__search" name="location_search" component="input" placeholder="Поиск по местонахождению" onChange={() => {
                            props.locationClear();
                ...
                <div className="postDepartmentLocation-page-edit__form-field form__field">
                    <label>
                        ...
                        <Field className="postDepartmentLocation-page-edit__search" name="dep_loc_search" component="input" placeholder="Поиск по отделу" onChange={() => {
                            props.depLocClear();
                        }} />
                    </label>
                </div>
                <div className="postDepartmentLocation-page-edit__form-field form__field">
                    <label>
                        ...
                        <Field className="postDepartmentLocation-page-edit__search" name="post_search" component="input" placeholder="Поиск по должности" onChange={() => {
                            props.postClear();
                        }} />
                    </label>
                </div>
